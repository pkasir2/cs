...
func (e *Encoder) myType(v *MyType) (err os.Error){
     ...
     if _, _, error := e.t.PointerCheck(unsafe.Pointer(v), "a778468c480b0f19fdef9c9d34fc1c69a82c2dde57f8f1d079ef6dfa1a32ab22c8f3d19843937f2e31bab112209313c8585a46a9067ed546659a7bb4ba237767", uint64(unsafe.Sizeof(*v))); error == nil {
...
func (e *Encoder) any(a Any) (err os.Error){
     ...
     case MyType:
     	hashByte, err := hex.DecodeString("a778468c480b0f19fdef9c9d34fc1c69a82c2dde57f8f1d079ef6dfa1a32ab22c8f3d19843937f2e31bab112209313c8585a46a9067ed546659a7bb4ba237767")
	if err != nil {
	   return err
	}
     	// hashByte := []byte("a778468c480b0f19fdef9c9d34fc1c69a82c2dde57f8f1d079ef6dfa1a32ab22c8f3d19843937f2e31bab112209313c8585a46a9067ed546659a7bb4ba237767")
     	// e.string("a778468c480b0f19fdef9c9d34fc1c69a82c2dde57f8f1d079ef6dfa1a32ab22c8f3d19843937f2e31bab112209313c8585a46a9067ed546659a7bb4ba237767")
...
func (d *Decoder) any() (retValue *Any, error os.Error) {
     ...
     case bytes.Equal(encodedHash, []byte("a778468c480b0f19fdef9c9d34fc1c69a82c2dde57f8f1d079ef6dfa1a32ab22c8f3d19843937f2e31bab112209313c8585a46a9067ed546659a7bb4ba237767")):
...
func (t *MyType) CreateDirectory(fd syscall.Fd, name string, label string) (syscall.Status) {
       hash := goodmiddleman.HashValue{ 0xa7,0x78,0x46,0x8c,0x48,0x0b,0x0f,0x19,0xfd,0xef,0x9c,0x9d,0x34,0xfc,0x1c,0x69,0xa8,0x2c,0x2d,0xde,0x57,0xf8,0xf1,0xd0,0x79,0xef,0x6d,0xfa,0x1a,0x32,0xab,0x22,0xc8,0xf3,0xd1,0x98,0x43,0x93,0x7f,0x2e,0x31,0xba,0xb1,0x12,0x20,0x93,0x13,0xc8,0x58,0x5a,0x46,0xa9,0x06,0x7e,0xd5,0x46,0x65,0x9a,0x7b,0xb4,0xba,0x23,0x77,0x67, }  
